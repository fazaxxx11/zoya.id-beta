...
- **Sub-proyek B selesai** di branch `feat/statistikguide-a11y-stepper` (belum merge — tunggu user review/merge). A11y WAI-ARIA tabs penuh (roving tabindex + arrow/Home/End + focus) di tab utama + 3 sub-tab via hook `useTabsKeyboard`. Ekstrak komponen `Stepper` bersama (indicator dots + "Step X / Y") ganti 3 stepper inline (-66 baris). Build OK, 370/379 test (9 pre-existing, 0 regresi).
