const BellCurve = ({ size = 300, className }) => {
  ...
  return (
    ...
    >
      ...
      {/* X-axis */}
      <line x1="20" y1="130" x2="280" y2="130" stroke="#94a3b8" strokeWidth="1" />
      ...
      <circle cx="150" cy="22" r="3" fill="#3b82f6" />
      <text x="150" y="16" textAnchor="middle" fontSize="10" fill="#1e3a5f" fontWeight="600">
        Mean / Median / Mode
      </text>
    </svg>
  );
