      ...
      panelClassName="bg-white rounded-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[10px] uppercase tracking-[0.18em] text-gray-400 font-medium">Onboarding</div>
        ...
        <div className="px-6 py-3 text-xs text-gray-500 border-b border-gray-100 bg-gray-50/60">
          ...
          {EXAMPLE_DATASETS.map(ds => {
            ...
            return (
              <button
                ...
                className="w-full text-left bg-white border border-gray-200 hover:border-gray-400 hover:bg-gray-50 rounded-xl p-4 transition-colors group"
              >
                <div className="flex items-start justify-between gap-3 mb-1.5">
                  <div className="text-sm font-semibold text-gray-900 group-hover:text-black">
                    {ds.name}
                  </div>
                  <span className="text-[10px] uppercase tracking-[0.14em] text-gray-400 bg-gray-100 px-2 py-0.5 rounded-full font-medium shrink-0">
